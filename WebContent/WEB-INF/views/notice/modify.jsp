                        ...
                        <div class="util" style="height: 40px;">
                            <ul style="height: 40px;">
                                ...
                                <li class="shares">
                                    ...
                                    <a href="https://www.youtube.com/channel/UCv5lNP1Jz5UBHgYryNoWzgA" target="_blank" class="newWin"> 
            ...
            <div id="container">
                <div class="page-title">
                    ...
                    <ul>
                        <li>
                            <label>제목</label> 
                            <input type="text" id="notice-subject" name="subject" value="${notice.noticeSubject }">
                        </li>
                        <li>
                            <label>내용</label> 
                            <textarea name="content" id="notice-content" rows="40" cols="100">${notice.noticeContent }</textarea>
                        </li>
                    </ul>
                    <div class="btn-area">
